...
for i in "${!z_ranges[@]}";do
    ...
    sed "s/#z_range#/${z_range}/g; s/#step_list#/${steps}/g; s@#gltcs_file#@${gltcs_file}@g; s/#z_type#/${z_type}/g" <cosmoDC2_v0.0.0_z_template.param >cosmoDC2_v0.0.0_z_${z_range}.param
    cat cosmoDC2_v0.0.0_z_${z_range}.param | grep gltcs
done
