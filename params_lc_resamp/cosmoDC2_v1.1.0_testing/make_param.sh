...
z_types=("low_z")
healpix_groups=("10066 10067 10068 10069 10070 ")
...
for i in "${!z_ranges[@]}";do
	...
	sed "s/#z_range#/${z_range}/g; s/#step_list#/${steps}/g; s@#gltcs_file#@${gltcs_file}@g; s/#z_type#/${z_type}/g; s/#healpix_group#/${healpix_group}/g; s/#v1#/${v1}/g; s/#v2#/${v2}/g; s/#v3#/${v3}/g"<template.param >cosmoDC2_v${v1}.${v2}.${v3}_testing_z_${z_range}_hp:${healpix_name}.param
	sed "s/#z_range#/${z_range}/g; s/#step_list#/${steps}/g; s@#gltcs_file#@${gltcs_file}@g; s/#z_type#/${z_type}/g; s/#healpix_name#/${healpix_name}/g; s/#v1#/${v1}/g; s/#v2#/${v2}/g; s/#v3#/${v3}/g"<template.sh >run_cosmoDC2_v${v1}.${v2}.${v3}_testing_z_${z_range}_hp:${healpix_name}.sh
	chmod +x run_cosmoDC2_v${v1}.${v2}.${v3}_testing_z_${z_range}_hp:${healpix_name}.sh
    echo "qsub -n 1 -t 720 -o params_lc_resamp/cosmoDC2_v${v1}.${v2}.${v3}_testing/logs/${z_range}_${healpix_name}.out -e params_lc_resamp/cosmoDC2_v${v1}.${v2}.${v3}_testing/logs/${z_range}_${healpix_name}.err  --debuglog=params_lc_resamp/cosmoDC2_v${v1}.${v2}.${v3}_testing/logs/${z_range}_${healpix_name}.cobalt  ./lc_resample.py params_lc_resamp/cosmoDC2_v${v1}.${v2}.${v3}_testing/cosmoDC2_v${v1}.${v2}.${v3}_testing_z_${z_range}_hp:${healpix_name}.param" >> "submit_all.sh"
    echo "./lc_resample.py params_lc_resamp/cosmoDC2_v${v1}.${v2}.${v3}_testing/cosmoDC2_v${v1}.${v2}.${v3}_testing_z_${z_range}_hp:${healpix_name}.param" >> "run_all_login.sh"
    done
done
